...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#020617] text-white selection:bg-cyan-500/30 selection:text-cyan-200">
      <Header />
      ...
      <div className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {!isConnected ? (
            <div className="flex flex-col items-center justify-center py-20 bg-white/5 border border-white/10 rounded-[3rem] backdrop-blur-xl">
